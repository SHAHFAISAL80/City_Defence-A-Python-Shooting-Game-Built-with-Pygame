...
background_start = pg.image.load(path.join(image_dir, r"C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\urban_long_grey.png")).convert()
background = pg.image.load(path.join(image_dir, r"C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\urban_long.png")).convert()
player_img = pg.image.load(path.join(image_dir, r"C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\plane_white.png")).convert()
laser_img = pg.image.load(path.join(image_dir, r"C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\laser.png")).convert()
heart_img = pg.image.load(path.join(image_dir, r"C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\heart.png")).convert()
heart_mini_img = pg.transform.scale(heart_img, (25, 19))
heart_mini_img.set_colorkey(BLACK)

enemy_images = []
enemy_list = [r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\virus_red.png', r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\virus_blue.png', r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\image\virus_violet.png']

for image in enemy_list:
    enemy_images.append(pg.image.load(path.join(image_dir, image)).convert())

shoot_sound = pg.mixer.Sound(path.join(sound_dir, r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\sound\laser.wav'))
shield_sound = pg.mixer.Sound(path.join(sound_dir, r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\sound\shield.wav'))
powerup_sound = pg.mixer.Sound(path.join(sound_dir, r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\sound\powerup.wav'))
explosion_sound = pg.mixer.Sound(path.join(sound_dir, r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\sound\explosion.wav'))
player_die_sound = pg.mixer.Sound(path.join(sound_dir, r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\sound\explosion_player.ogg'))
pg.mixer.music.load(path.join(sound_dir, r'C:\Users\Al Shahbaz\Videos\new projects\City_Defence-main\sound\FrozenJam-SeamlessLoop.ogg'))
